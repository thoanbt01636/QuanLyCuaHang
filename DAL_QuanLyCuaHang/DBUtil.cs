...
namespace DAL_QuanLyCuaHang
{
    public class DBUtil
    {
        ...
        public static string connString = @"Data Source=THOAN2410;Initial Catalog=SUM2025_PolyCafe;Integrated Security=True;Encrypt=True;Trust Server Certificate=True";
